                ...
                <div className="bg-linear-to-r from-primary to-primary-focus h-32 px-6 flex items-end justify-between pb-4">
                    <div className="flex items-center gap-4 translate-y-8">
                        <div className="avatar placeholder">
                            <div className="bg-neutral text-neutral-content rounded-2xl w-24 h-24 border-4 border-base-100 font-black text-2xl">DR</div>
                        </div>
                ...
                <form onSubmit={handleUpdate} className="p-6 pt-16 space-y-4">
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" value={profile.emergencyContact} onChange={e => setProfile({ ...profile, emergencyContact: e.target.value })} className="input input-bordered w-full pl-10 rounded-xl font-semibold" />
                        </div>
                    </div>
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            ...
                            <textarea value={profile.permanentAddress} onChange={e => setProfile({ ...profile, permanentAddress: e.target.value })} className="textarea textarea-bordered w-full pl-10 rounded-xl font-semibold h-20" />
                        </div>
                    </div>
